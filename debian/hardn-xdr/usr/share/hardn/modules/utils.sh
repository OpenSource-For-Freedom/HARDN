...
# Wrapper for whiptail that works in non-interactive mode
whiptail_wrapper() {
    local type="$1"
    shift
...
export -f is_non_interactive is_dry_run is_force_mode whiptail_wrapper safe_execute
